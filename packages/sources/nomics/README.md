...
![1.2.6](https://img.shields.io/github/package-json/v/smartcontractkit/external-adapters-js?filename=packages/sources/nomics/package.json)
...
|           | pageSize | `page`, `pageLength`, `perPage` | The maximum number of items to return per paginated response. | number |         |  `100`  |            |                |
